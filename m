Return-Path: <linux-remoteproc+bounces-7952-lists+linux-remoteproc=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-remoteproc@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id kInCMn2OGWpTxggAu9opvQ
	(envelope-from <linux-remoteproc+bounces-7952-lists+linux-remoteproc=lfdr.de@vger.kernel.org>)
	for <lists+linux-remoteproc@lfdr.de>; Fri, 29 May 2026 15:02:53 +0200
X-Original-To: lists+linux-remoteproc@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [104.64.211.4])
	by mail.lfdr.de (Postfix) with ESMTPS id E6FF86029E1
	for <lists+linux-remoteproc@lfdr.de>; Fri, 29 May 2026 15:02:52 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id F142D300A64F
	for <lists+linux-remoteproc@lfdr.de>; Fri, 29 May 2026 13:02:49 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 053E3282F0A;
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-7952-lists,linux-remoteproc=lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[srini@kernel.org,linux-remoteproc@vger.kernel.org];
