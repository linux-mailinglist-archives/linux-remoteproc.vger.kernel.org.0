Return-Path: <linux-remoteproc+bounces-7394-lists+linux-remoteproc=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-remoteproc@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id KC1RDqlh6GlaJwIAu9opvQ
	(envelope-from <linux-remoteproc+bounces-7394-lists+linux-remoteproc=lfdr.de@vger.kernel.org>)
	for <lists+linux-remoteproc@lfdr.de>; Wed, 22 Apr 2026 07:50:33 +0200
X-Original-To: lists+linux-remoteproc@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id CD4314422C8
	for <lists+linux-remoteproc@lfdr.de>; Wed, 22 Apr 2026 07:50:32 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 40D863040447
	for <lists+linux-remoteproc@lfdr.de>; Wed, 22 Apr 2026 05:46:45 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CB8352BEFEB;
...
X-Spamd-Result: default: False [3.84 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-7394-lists,linux-remoteproc=lfdr.de];
	FROM_HAS_DN(0.00)[];
