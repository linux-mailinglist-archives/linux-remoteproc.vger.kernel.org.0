Return-Path: <linux-remoteproc+bounces-6948-lists+linux-remoteproc=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-remoteproc@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id yMpbOboUs2mDSAAAu9opvQ
	(envelope-from <linux-remoteproc+bounces-6948-lists+linux-remoteproc=lfdr.de@vger.kernel.org>)
	for <lists+linux-remoteproc@lfdr.de>; Thu, 12 Mar 2026 20:32:10 +0100
X-Original-To: lists+linux-remoteproc@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 5DF57278057
	for <lists+linux-remoteproc@lfdr.de>; Thu, 12 Mar 2026 20:32:10 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 4355A305B4AA
	for <lists+linux-remoteproc@lfdr.de>; Thu, 12 Mar 2026 19:30:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4F091401A12;
...
X-Spamd-Result: default: False [2.84 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-6948-lists,linux-remoteproc=lfdr.de];
	URIBL_MULTI_FAIL(0.00)[nxp.com:server fail,bgdev.pl:server fail,tor.lore.kernel.org:server fail,lunn.ch:server fail];
	...
	FROM_NEQ_ENVFROM(0.00)[shenwei.wang@nxp.com,linux-remoteproc@vger.kernel.org];
	FROM_HAS_DN(0.00)[];
	TO_DN_SOME(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[nxp.com:dkim,nxp.com:email,nxp.com:mid,tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns,bgdev.pl:email]
X-Rspamd-Queue-Id: 5DF57278057
