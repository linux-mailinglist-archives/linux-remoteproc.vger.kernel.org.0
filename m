Return-Path: <linux-remoteproc+bounces-7877-lists+linux-remoteproc=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-remoteproc@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id aGwDKNg5EGoaVAYAu9opvQ
	(envelope-from <linux-remoteproc+bounces-7877-lists+linux-remoteproc=lfdr.de@vger.kernel.org>)
	for <lists+linux-remoteproc@lfdr.de>; Fri, 22 May 2026 13:11:20 +0200
X-Original-To: lists+linux-remoteproc@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DACD5B2C65
	for <lists+linux-remoteproc@lfdr.de>; Fri, 22 May 2026 13:11:20 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 136C23005589
	for <lists+linux-remoteproc@lfdr.de>; Fri, 22 May 2026 11:11:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5122E3CC7DF;
...
X-Spamd-Result: default: False [2.34 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-7877-lists,linux-remoteproc=lfdr.de];
	...
	TO_DN_SOME(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[sto.lore.kernel.org:rdns,sto.lore.kernel.org:helo,linuxfoundation.org:email,linuxfoundation.org:dkim,gitlab.com:url]
X-Rspamd-Queue-Id: 4DACD5B2C65
